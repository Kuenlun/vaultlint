...
class OutputManager:
    ...
    def print_warning(self, message: str, path: str = None):
        ...
        if path:
            console.print(f"! {message} '[bold]{path}[/bold]'")
        else:
    ...
    def print_summary_success(self, vault_path: str, spec_name: str = None, 
                            files_checked: int = 0, checks_run: int = 0):
    ...
    def print_summary_failure(self, vault_path: str, spec_name: str = None,
                            files_checked: int = 0, checks_run: int = 0,
                            issues: list = None):
